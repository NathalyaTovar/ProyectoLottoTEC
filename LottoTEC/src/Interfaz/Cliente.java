...
public void Mostrar(){
    ...
    Usuario usuario=new Usuario(Integer.parseInt(caja1.getText()),fecha.getDate(),caja2.getText(),caja3.getText(),Integer.parseInt(caja4.getText()),caja5.getText());
    GestionPrincipal.getInstance().registrarUsuario(usuario);
    Mostrar();
